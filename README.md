...
**nCHAT** is a Ruby on Rails blog application that allows users to send messages to each other that can only be read once.

Submitted by: **Nhiem Ngo**

Time spent: **18** hours

URL: **http://young-hollows-66887.herokuapp.com**
